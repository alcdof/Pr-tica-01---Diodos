...
plt.xlabel(r'$V_D$ (V)')
plt.ylabel(r'$I_d$ (mA)')
plt.title('Gráfico da corrente em um diodo em função da tensão aplicada sobre ele')
plt.grid(True)

plt.plot(tensao_1N4148, corrente_1N4148, label='Diodo 1N4148')
plt.plot(tensao_1N400x, corrente_1N400x, label='Diodo 1N400x')
